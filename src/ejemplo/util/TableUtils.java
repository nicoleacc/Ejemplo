...
public class TableUtils {
    ...
    public static void copySelectionToClipboard(TableView<?> table) {
        System.out.println("inside copy " + table.isEditable());
...
//                System.out.println(rowTable + "/" + colTable);
            ...
            System.out.println("The " + table.getId() + " is non editable");
        }
    }
    ...
    public static void selectALL(TableView<?> table) {
        System.out.println(new Timestamp(System.currentTimeMillis()) + " - All Data Base Table Selected");
    ...
    public static void selectPartial(TableView<?> table) {
        System.out.println(table.getSelectionModel().getSelectedIndices());
        if (table.getSelectionModel().getSelectedIndices().size() == 1) {
            System.out.println(new Timestamp(System.currentTimeMillis()) + " - Data Base Table Single Row Selection: " + table.getSelectionModel().getSelectedIndices().get(0) + 1);
            table.getSelectionModel().select(table.getSelectionModel().getSelectedIndices().get(0));
        } else {
            System.out.println(new Timestamp(System.currentTimeMillis()) + " - Data Base Table Selection initial row: " + table.getSelectionModel().getSelectedIndices().get(0) + 1);
            System.out.println(new Timestamp(System.currentTimeMillis()) + " - Data Base Table Selection final row: " + table.getSelectionModel().getSelectedIndices().get(table.getSelectionModel().getSelectedIndices().size() - 1) + 1);
            table.getSelectionModel().selectRange(table.getSelectionModel().getSelectedIndices().get(0), table.getSelectionModel().getSelectedIndices().get(table.getSelectionModel().getSelectedIndices().size() - 1) + 1);
        }
    }
}
